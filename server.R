...
server <- function(input, output) {
  ...
  shinyDirChoose(input, 'dir', roots = c(rootMAC="/",rootWindows="C:/", home="~/",currentDirectory='./'))
        ...
        #Progress bar based on the markers
          withProgress(message = 'Plotting markers:', value = 0, {
            ...
            for (j in vectMarkers){
              ...
              #Plot
              pdf(paste0(input$dir$path[[2]][1], "/", savedname, "/", strsplit(names(mydata)[j],">")[[1]][2], "_Time.pdf"))
